const questions = [
    ...
    },
    {
        ...
        options: ["Atribuição de valor", "Comparação de igualdade", 
            "Incremento de valor", "Operação lógica AND"],
        answer: "Comparação de igualdade"
    },
    {
        question: "Qual dos seguintes comandos é usado para imprimir uma mensagem no console em Java?",
        options: ["print('Mensagem')", "System.print('Mensagem')", "System.out.print('Mensagem')", 
            "System.out.println('Mensagem')"],
        answer: "System.out.println('Mensagem')"
    },
    {
        question: "Qual é o valor da variável x após a execução do código: int x = 5; x += 3;?",
        options: ["5", "3", 
            "8 ", "10"],
        answer: "8"
    },
